...
function baseBacktestRun(overrides = {}) {
  return {
    id: "run-accounting",
    ...
    strategy_version: "1",
    strategy_configuration: { profile_name: "default", parameters: {} },
    dataset_id: "dataset-utc",
    dataset_checksum: "a".repeat(64),
    shortlist: ["TEST_FX"],
    timeframe: "1m",
    requested_start_at: "2026-01-01T00:00:00Z",
    requested_end_at: "2026-01-01T00:06:00Z",
    warmup_mode: "NONE",
    warmup_candle_count: 0,
    allow_insufficient_warmup: false,
    warmup_start_at: "2026-01-01T00:00:00Z",
    trading_start_at: "2026-01-01T00:00:00Z",
    warmup_sufficient: true,
    warmup_degraded: false,
    warmup_warnings: [],
    effective_start_at: "2026-01-01T00:00:00Z",
    effective_end_at: "2026-01-01T00:06:00Z",
    ...
    evaluation_boundary: "CANDLE_CLOSE_NEXT_OPEN",
    status: "COMPLETED",
    created_at: "2026-01-01T01:00:00Z",
    started_at: "2026-01-01T01:00:00Z",
    completed_at: "2026-01-01T01:00:01Z",
    failure_reason: null,
    result_manifest_version: "BACKTEST_RESULT_MANIFEST_V2",
...
function baseBacktestMetrics(overrides = {}) {
  return {
    ...
    spread_cost: 2,
    slippage_cost: 0.5,
    net_closed_trade_pnl: 11,
    total_pnl: 14,
    ending_equity: 1014,
    ending_cash: 1011,
    open_position_value: 103,
    return_pct: 1.4,
    closed_trade_return_pct: 1.1,
    headline_return_includes_unrealised: true,
    closed_trade_count: 2,
    winning_closed_trades: 1,
    losing_closed_trades: 1,
    breakeven_closed_trades: 0,
    closed_trade_win_rate: 50,
    closed_trade_net_winning_pnl: 13,
    closed_trade_net_losing_pnl: -2,
    maximum_drawdown: 2,
    maximum_drawdown_percentage: 0.2,
    profit_factor: 6.5,
    profit_factor_null_reason: null,
    average_closed_trade_pnl: 5.5,
    average_winner: 13,
    average_loser: -2,
    largest_winner: 13,
    largest_loser: -2,
    wall_clock_exposure_pct: 50,
...
export function buildScenarioRoutes(name) {
  switch (name) {
    case "backtests-utc-dataset":
      return mergeRoutes({
        "GET /historical-data/providers": ok([
          {
            provider_id: "TEST",
            venue: "TEST_VENUE",
            supported_asset_classes: ["FOREX"],
        ...
        "GET /strategies": ok([
          {
            ...
            description: "Browser fixture strategy",
            instrument: "TEST_FX",
            status: "STOPPED",
            current_pnl: 0,
            trade_count: 0,
        ...
        "GET /historical-data/datasets": ok([
          {
            id: "dataset-utc",
            display_name: "UTC dataset",
            provider: "CSV",
            source_identifier: "utc.csv",
            venue: "TEST",
            market_type: "SPOT_FX",
            asset_class: "FOREX",
            base_timeframe: "1m",
            ...
            availability_updated_at: "2026-01-01T01:00:00Z",
            selectable: true,
            earliest_at: "2026-01-01T00:00:00Z",
            latest_at: "2026-01-01T00:05:00+00:00",
            candle_count: 6,
            timezone_rule: "UTC",
            price_components: ["trade"],
            volume_available: true,
            imported_at: "2026-01-01T01:00:00Z",
            checksum: "a".repeat(64),
            completeness_status: "COMPLETE_FOR_INTERVAL",
            detected_gaps: [],
            warnings: [],
            source_metadata: { source: "browser fixture" },
            import_parameters: {
              start_at: "2026-01-01T00:00:00Z",
              end_at: "2026-01-01T00:06:00Z",
            },
            failure_reason: null,
            storage_format: "JSONL_GZIP_V1",
            immutable: true,
            partitions: [],
          },
        ]),
        "GET /historical-data/datasets/dataset-utc": ok({
          id: "dataset-utc",
          display_name: "UTC dataset",
          provider: "CSV",
          source_identifier: "utc.csv",
        ...
        "GET /backtests": ok([baseBacktestRun()]),
        "GET /backtests/run-accounting": ok(baseBacktestRun({
          warmup_mode: "CANDLE_COUNT",
          warmup_candle_count: 2,
          allow_insufficient_warmup: true,
          warmup_start_at: "2025-12-31T23:59:00Z",
          trading_start_at: "2026-01-01T00:00:00Z",
          ...
          warmup_warnings: [{
            ...
            available_warmup_candles: 1,
            message: "TEST_FX supplied 1 of 2 required warm-up candles.",
            first_available_at: "2025-12-31T23:59:00Z",
            trading_start_at: "2026-01-01T00:00:00Z",
          }],
        })),
        "GET /backtests/run-accounting/metrics": ok({
          run: baseBacktestMetrics(),
          by_instrument: {},
        }),
        "GET /backtests/run-accounting/trades": ok([
          {
            id: 1,
          ...
          },
          {
            ...
            open_price: 1.08456,
            close_price: 1.085,
            open_time: "2026-01-01T00:03:00Z",
            close_time: "2026-01-01T00:04:00Z",
            gross_pnl: -0.00044,
            fees: 0,
            spread_cost: 0,
            slippage_cost: 0,
        ...
        "GET /backtests/run-accounting/equity": ok([
          {
        ...
        "GET /backtests/run-accounting/warnings": ok([
          {
            id: 1,
            run_id: "run-accounting",
            deterministic_sequence: 1,
            ...
            details: { required_candles: 2, consumed_candles: 1 },
            created_at: "2026-01-01T00:06:00Z",
          },
        ]),
        "GET /backtests/run-accounting/instruments": ok([
          {
            instrument: "TEST_FX",
            provider_instrument: "TEST_FX",
            dataset_partition_id: 1,
            candle_count: 6,
            warmup_candles_consumed: 1,
            first_tradable_at: "2026-01-01T00:00:00Z",
            metrics: baseBacktestMetrics(),
          },
        ]),
        "POST /historical-data/imports": response(201, {
          id: "dataset-utc",
          display_name: "UTC dataset",
        }),
        "POST /backtests": response(201, {
          id: "run-utc",
          status: "COMPLETED",
        }),
      });
    case "backtests-strict-warmup-failed": {
      const routes = buildScenarioRoutes("backtests-utc-dataset");
      const failedRun = baseBacktestRun({
        id: "run-strict-warmup-failed",
        name: "Strict warm-up failure",
        ...
        warmup_warnings: [
          {
            code: "INSUFFICIENT_WARMUP",
            severity: "ERROR",
            instrument_id: "ALPHA_FX",
            requested_warmup_candles: 2,
            available_warmup_candles: 0,
            message: "ALPHA_FX supplied 0 of 2 required warm-up candles.",
          ...
          },
          {
            code: "INSUFFICIENT_WARMUP",
            severity: "ERROR",
            instrument_id: "BETA_FX",
            requested_warmup_candles: 2,
            available_warmup_candles: 0,
            message: "BETA_FX supplied 0 of 2 required warm-up candles.",
            first_available_at: null,
            trading_start_at: "2026-01-01T00:00:00Z",
          },
        ],
        ...
        status: "FAILED",
        failure_reason:
          "ALPHA_FX supplied 0 of 2 required warm-up candles.; BETA_FX supplied 0 of 2 required warm-up candles.",
        result_manifest_version: null,
        result_checksum: null,
      });
      return {
        ...routes,
        "GET /backtests": ok([failedRun]),
        "GET /backtests/run-strict-warmup-failed": ok(failedRun),
        "GET /backtests/run-strict-warmup-failed/warnings": ok([
          {
            id: 1,
            run_id: failedRun.id,
            deterministic_sequence: 1,
        ...
        "GET /backtests/run-strict-warmup-failed/instruments": ok([
          {
            instrument: "ALPHA_FX",
            provider_instrument: "ALPHA_FX",
            dataset_partition_id: 1,
            candle_count: 6,
            warmup_candles_consumed: 0,
            first_tradable_at: "2026-01-01T00:00:00Z",
            metrics: null,
          },
          {
            instrument: "BETA_FX",
            provider_instrument: "BETA_FX",
            dataset_partition_id: 2,
            candle_count: 6,
            warmup_candles_consumed: 0,
            first_tradable_at: "2026-01-01T00:00:00Z",
            metrics: null,
