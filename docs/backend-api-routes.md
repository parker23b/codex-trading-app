...
| GET | `/backtests/{run_id}/equity` | `app.api.routes.backtesting.get_backtest_equity` | `PASSIVE_READ` | `operator` | `getBacktestEquity` | Explicit model: list[BacktestEquityPointResponse] | Completed-run equity and drawdown curve; failed runs return 409. |
...
| GET | `/backtests/{run_id}/metrics` | `app.api.routes.backtesting.get_backtest_metrics` | `PASSIVE_READ` | `operator` | `getBacktestMetrics` | Explicit model: BacktestMetricsResponse | Completed-run metrics; failed runs return 409. |
| GET | `/backtests/{run_id}/trades` | `app.api.routes.backtesting.get_backtest_trades` | `PASSIVE_READ` | `operator` | `getBacktestTrades` | Explicit model: list[BacktestTradeResponse] | Completed-run simulated trade ledger; failed runs return 409. |
