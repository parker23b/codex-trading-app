...
ROUTE_MANIFEST: tuple[RouteManifestEntry, ...] = (
    ...
    _entry(
        ...
        "app.api.routes.backtesting.list_historical_providers",
        RouteClassification.PASSIVE_READ,
        frontend_consumers=("getHistoricalProviders",),
        notes="Configured historical provider capabilities.",
    ),
    _entry(
        "GET",
        "/historical-data/providers/{provider_id}",
        "app.api.routes.backtesting.get_historical_provider",
        RouteClassification.PASSIVE_READ,
        notes="Historical provider capability detail.",
    ),
    _entry(
        "POST",
        "/historical-data/imports",
        "app.api.routes.backtesting.import_historical_provider_data",
        RouteClassification.MUTATION,
        frontend_consumers=("importHistoricalProviderData",),
        notes="Explicit external historical-data ingestion into an immutable snapshot.",
    ),
    _entry(
        "POST",
        "/historical-data/imports/csv",
        "app.api.routes.backtesting.import_historical_csv",
        RouteClassification.MUTATION,
        frontend_consumers=("importHistoricalCsv",),
        notes="Explicit CSV ingestion into an immutable snapshot.",
    ),
    _entry(
        "GET",
        "/historical-data/imports/{dataset_id}",
        "app.api.routes.backtesting.get_historical_import",
        RouteClassification.PASSIVE_READ,
        notes="Historical import status projection.",
    ),
    _entry(
        "GET",
        "/historical-data/datasets",
        "app.api.routes.backtesting.list_historical_datasets",
        RouteClassification.PASSIVE_READ,
        frontend_consumers=("getHistoricalDatasets",),
        notes="Immutable historical dataset list.",
    ),
    _entry(
        "GET",
        "/historical-data/datasets/{dataset_id}",
        "app.api.routes.backtesting.get_historical_dataset",
        RouteClassification.PASSIVE_READ,
        frontend_consumers=("getHistoricalDataset",),
        notes="Historical dataset coverage and provenance detail.",
    ),
    _entry(
        "POST",
        "/backtests",
        "app.api.routes.backtesting.create_backtest",
        RouteClassification.MUTATION,
        frontend_consumers=("createBacktest",),
        notes="Bounded synchronous simulation action; never a broker mutation.",
    ),
    _entry(
        "GET",
        "/backtests",
        "app.api.routes.backtesting.list_backtests",
        RouteClassification.PASSIVE_READ,
        frontend_consumers=("getBacktests",),
        notes="Persisted backtest run list.",
    ),
    _entry(
        "GET",
        "/backtests/{run_id}",
        "app.api.routes.backtesting.get_backtest",
        RouteClassification.PASSIVE_READ,
        frontend_consumers=("getBacktest",),
        notes="Backtest run summary.",
    ),
    _entry(
        "GET",
        "/backtests/{run_id}/configuration",
        "app.api.routes.backtesting.get_backtest_configuration",
        RouteClassification.PASSIVE_READ,
        notes="Immutable backtest configuration snapshot.",
    ),
    _entry(
        "GET",
    ...
    _entry(
        ...
        "app.api.routes.backtesting.get_backtest_warnings",
        RouteClassification.PASSIVE_READ,
        frontend_consumers=("getBacktestWarnings",),
        notes="Simulation limitations and conservative-resolution warnings.",
    ),
    _entry(
        "GET",
        "/backtests/{run_id}/instruments",
        "app.api.routes.backtesting.get_backtest_instruments",
        RouteClassification.PASSIVE_READ,
        frontend_consumers=("getBacktestInstruments",),
        notes="Per-instrument backtest breakdown.",
    ),
    _entry(
        "POST",
